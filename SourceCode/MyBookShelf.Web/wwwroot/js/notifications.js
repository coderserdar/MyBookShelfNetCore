...
//------------------------------------------------------------------------------
        var _processInput = function (options) {
            ...
            if (options.size === 'mini' || options.size === 'large' || options.size === 'awesome') {
...
//------------------------------------------------------------------------------
    ...
    Lobibox.notify.DEFAULTS = {
        ...
        soundPath: '/Content/tools/otomasyon-notification/sounds/',       // The folder path where sounds are located
